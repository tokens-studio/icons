...
const SvgInnerShadowLeftFilled = ({
	...
	>
		...
		<path
			opacity={0.4}
			d='M8 5L8.10254 5.00488C8.60667 5.05621 9 5.48232 9 6V18C9 18.5523 8.55228 19 8 19H6C5.44772 19 5 18.5523 5 18V6L5.00488 5.89746C5.05621 5.39333 5.48232 5 6 5H8Z'
			fill='currentColor'
		/>
		<path
