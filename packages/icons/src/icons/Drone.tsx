...
const SvgDrone = ({
	...
	>
		...
		/>
		<path
			d='M12.9999 14.6666C13.9204 14.6666 14.6666 13.9204 14.6666 13C14.6666 12.0795 13.9204 11.3333 12.9999 11.3333C12.0795 11.3333 11.3333 12.0795 11.3333 13C11.3333 13.9204 12.0795 14.6666 12.9999 14.6666Z'
			stroke='currentColor'
			strokeMiterlimit={1.5}
			strokeLinecap='round'
			strokeLinejoin='round'
