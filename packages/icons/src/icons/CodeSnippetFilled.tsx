...
const SvgCodeSnippetFilled = ({
	...
	>
		...
		<path
			fillRule='evenodd'
			clipRule='evenodd'
			d='M14.2169 2.02378C14.7561 2.14359 15.096 2.67777 14.9762 3.2169L10.9762 21.2169C10.8564 21.756 10.3222 22.096 9.78307 21.9762C9.24394 21.8563 8.904 21.3222 9.02381 20.783L13.0238 2.78304C13.1436 2.24391 13.6778 1.90398 14.2169 2.02378Z'
			fill='currentColor'
		/>
	</svg>
);
export default SvgCodeSnippetFilled;
