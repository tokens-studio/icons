...
const SvgInnerShadowFilled = ({
	...
	>
		...
		<path
			opacity={0.4}
			d='M18 5L18.1025 5.00488C18.6067 5.05621 19 5.48232 19 6V18C19 18.5523 18.5523 19 18 19H6C5.44772 19 5 18.5523 5 18V6L5.00488 5.89746C5.05621 5.39333 5.48232 5 6 5H18ZM7 17H17V7H7V17Z'
			fill='currentColor'
		/>
		<path
...
export default SvgInnerShadowFilled;
