...
const SvgDatabaseStats = ({
	...
	>
		...
		<path
			...
			strokeLinejoin='round'
		/>
		<path d='M10 14V12.6667' stroke='currentColor' strokeLinecap='round' />
		<path d='M12 14V11.3333' stroke='currentColor' strokeLinecap='round' />
		<path d='M14 14V10' stroke='currentColor' strokeLinecap='round' />
	</svg>
);
