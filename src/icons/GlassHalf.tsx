...
const SvgGlassHalf = ({
	...
	>
		...
		<path
			stroke='currentColor'
			strokeWidth={1.5}
			d='M2 3.333c1.714 1.778 10.286 1.778 12 0M2.667 8.667c.687.802 2.616 1.242 4.666 1.32.897.034 1.817 0 2.667-.105 1.51-.186 2.798-.591 3.333-1.215M2.667 8.667c1.523-1.778 9.143-1.778 10.666 0'
		/>
	</svg>
);
