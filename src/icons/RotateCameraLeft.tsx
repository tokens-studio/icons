...
const SvgRotateCameraLeft = ({
	...
	>
		...
		<path
			...
			strokeWidth={1.5}
			d='M1.367 2v2.998c0 .185.15.335.335.335.134 0 .254-.079.311-.2a6.667 6.667 0 0 1 12.655 2.2M14.668 14v-2.998a.335.335 0 0 0-.336-.335.35.35 0 0 0-.31.2 6.667 6.667 0 0 1-12.655-2.2'
		/>
		<path
			stroke='currentColor'
			strokeLinecap='round'
