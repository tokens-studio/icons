...
const SvgBox3DThreePoints = ({
	...
	>
		...
		<path
			...
			strokeWidth={1.5}
			d='M8 15.333A.667.667 0 1 0 8 14a.667.667 0 0 0 0 1.333M2 5.333A.667.667 0 1 0 2 4a.667.667 0 0 0 0 1.333M2 12a.667.667 0 1 0 0-1.333A.667.667 0 0 0 2 12'
		/>
		<path
			stroke='currentColor'
			strokeLinecap='round'
