...
const SvgKeyframesPlus = ({
	...
	>
		...
		<path
			...
			strokeWidth={1.5}
			d='M1.333 8h2m0 0h2m-2 0V6m0 2v2M4.167 4l.163-.187a1.333 1.333 0 0 1 2.007 0l2.895 3.309c.44.503.44 1.253 0 1.756l-2.895 3.309a1.333 1.333 0 0 1-2.007 0L4.167 12'
		/>
		<path
			stroke='currentColor'
			strokeLinecap='round'
